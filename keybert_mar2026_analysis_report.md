...
**W5 (23.03) 특이사항:** 9건 전부 DSHI로 단일 벤더 집중 점검 실시하였음.
...
> **Vendor 순위 변동:** W5(23.03)에서 DSHI 9건 추가 → DSHI(76건)가 Hankuk(68건)을 역전하여 1위 등극
...
**주요 특이사항:**
- **DSHI** — W5(23.03) 9건 전부 DSHI 단독 발생; 인양·추락 이슈 각각 42건으로 동률 — 집중 관리 필요
- **DSHI Vendor 순위 역전** — 총 건수 기준 Hankuk(68)을 앞서 1위 등극 (W4까지는 67건으로 동률)
...
| 7 | **W5(23.03) 9건 전부 DSHI** — 단일 벤더 집중 발생 | DSHI 현장 전담 안전 담당자 배치 및 일일 점검 강화 |
...
> **W5 특이사항:** DSHI 9건 / Hankuk 0건 — 주말 직전(월요일) DSHI 집중 작업 패턴 주목
...
**W5 (03.23, 9건)**
- 9건 전부 **DSHI 단독 발생** — 단일 벤더 집중이라는 새로운 위험 패턴
