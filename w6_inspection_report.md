# Site Safety Inspection Report — W6 (30.03 – 03.04.2026)

**Project:** SDN Module Expansion PJT
**Inspection Period:** 30.03.2026 – 03.04.2026
**Inspector:** Rahul Mor · Surender Kumar
**Company:** Hanmi
...
W6(30.03–03.04) 기간 총 **40건**의 안전 위반이 기록됐다.

- **⑤ 전도·낙하·부딪힘**이 20건(50.0%)으로 압도적 1위 — 낙하물·인양 리깅 불량·자재 붕괴 위험 복합
- **④ 떨어짐·낙상** 8건(20.0%) — "Unsafe opening at height" 패턴이 3건 반복 (Hankuk, 02–03.04)
- **③ 감전·합선** 4건(10.0%) — Hankuk 3건 중 HIGH RISK 1건 (맨발 전기 작업, 02.04)
- **RTCC 신규 등장** — 01.04 콘크리트 타설 작업 4건 (⑤ 3건 + Minor 1건)
- 조치 완료 30건(75.0%), **미조치 10건(25.0%)** — Hankuk 6건·DSHI 2건·RTCC 1건·Daemyoung 1건

**주요 위험 요인:**  
인양 구역 하부 미차단 + 리깅 불량이 중대재해 직결 조합으로 31.03–01.04 집중 발생.  
Hankuk 전기 작업 안전 수준 전반 저하 (감전 3건, 03.04).
...
| 항목 | 내용 |
|------|------|
| 점검 기간 | 30.03.2026 – 03.04.2026 (5일) |
| 총 위반 건수 | 40건 |
| 조치 완료 | 30건 (75.0%) |
| 미조치 | 10건 (25.0%) |
...
| Risk Type | 건수 | 비율 | 조치完 | 미조치 |
|-----------|-----:|-----:|------:|------:|
| ⑤ 전도·낙하·부딪힘 | 20 | 50.0% | 16 | 4 |
| ④ 떨어짐·낙상 | 8 | 20.0% | 6 | 2 |
| N/A Minor | 6 | 15.0% | 6 | 0 |
| ③ 감전·합선 | 4 | 10.0% | 2 | 2 |
| ⑦ 끼임 | 1 | 2.5% | 0 | 1 |
| ② 화재·탄화 | 1 | 2.5% | 1 | 0 |
| **합계** | **40** | **100%** | **30** | **10** |
...
| Vendor | ④ 떨어짐·낙상 | ⑤ 전도·낙하·부딪힘 | N/A Minor | ③ 감전·합선 | ② 화재 | ⑦ 끼임 | **합계** | 미조치 |
|--------|----------:|---------------:|----------:|----------:|------:|------:|------:|------:|
| **DSHI** | 1 | 9 | 5 | 1 | 1 | 0 | **17** | 2 |
| **Hankuk** | 7 | 7 | 0 | 3 | 0 | 0 | **17** | 6 |
| RTCC | 0 | 3 | 1 | 0 | 0 | 0 | **4** | 1 |
| Samho | 0 | 1 | 0 | 0 | 0 | 0 | **1** | 0 |
| Daemyoung | 0 | 0 | 0 | 0 | 0 | 1 | **1** | 1 |
| **합계** | **8** | **20** | **6** | **4** | **1** | **1** | **40** | **10** |

**특이사항:**
- **Hankuk** — ④ 7건·⑤ 7건 균형, ③ 감전 3건 집중 (W6 최다 위험 유형), 미조치율 35.3%
- **DSHI** — ⑤ 9건(52.9%) 집중, Minor 5건은 문서·장비 태그 관리 소홀
- **RTCC** — 신규 등장 4건 전부 01.04 콘크리트 타설 현장 (⑤ 3건·Minor 1건)
...
|------|-----:|--------|--------------|:-----------:|
| 30.03 (월) | 10 | DSHI 4 · Hankuk 5 · Samho 1 | ⑤ Dropping 4건 · ④ Falling 3건 | 7 / 3 |
| 31.03 (화) | 8 | DSHI 6 · Hankuk 2 | ⑤ Dropping 4건 · ⑤ Collapse 1건 | 5 / 3 |
| 01.04 (수) | 8 | DSHI 2 · Hankuk 2 · RTCC 4 | ⑤ 4건 · ③ 1건 · ④ 1건 | 6 / 2 |
| 02.04 (목) | 7 | DSHI 3 · Hankuk 4 | ④ 2건 · ⑤ 4건 · ③ 1건 | 7 / 0 |
| 03.04 (금) | 7 | DSHI 2 · Hankuk 4 · Daemyoung 1 | ③ 2건 · ④ 2건 · ⑦ 1건 | 5 / 2 |
...
| # | 발견 사항 | 위험도 | 권고 조치 |
|---|---------|:------:|---------|
| 1 | **⑤ 인양 하부 미차단 반복** (No.210, 224) — 리깅 불량 + 진입통제 미비 복합 | 🔴 Critical | 인양 시 하부 바리케이드 2중 확인, 신호수 상시 배치 의무화 |
| 2 | **④ 개구부 미차단 반복** (No.222, 226, 227, 233, 237) — 5건 중 4건 Hankuk | 🔴 Critical | Hankuk 구역 고소 개구부 전수 목록화, 일일 점검표 제출 의무화 |
| 3 | **③ 감전 Hankuk 3건** (No.231 HIGH RISK: 맨발 전기 작업, No.235 노출 케이블) | 🔴 Critical | Hankuk 전기 작업 즉시 절연 PPE 착용 점검, 노출 케이블 당일 조치 확인 |
| 4 | **NEAR MISS** No.230 — 유압 팔레트 트롤리 하중 미고정 편하중 이동 | 🔴 Critical | 중량물 이동 전 하중 고정 절차 재교육, 단독 작업 금지 |
| 5 | **RTCC 신규 4건** (01.04) — 콘크리트 타설 공정 전반 미흡 | 🟠 High | RTCC 콘크리트 작업 투입 전 안전 절차 사전 확인, 가이드 로프·고임목 의무화 |
| 6 | **⑤ Collapse 4건** (No.200, 213, 220, 229) — 지지대 미설치·손상 자재 반복 | 🟠 High | 가설 구조물 지지 상태 일일 확인, 손상 비계 자재 즉시 반출 |
| 7 | **DSHI N/A 5건** — 훈련 미서명·문서 미게시·장비 태그 미부착 | 🟡 Medium | 문서 관리 체계 점검, 작업 전 SOP 게시 확인 루틴 수립 |
| 8 | **Hankuk 미조치율 35.3%** (6/17건) — W6 주간 가장 높은 미이행률 | 🟡 Medium | 미조치 항목 담당자 지정 및 주 단위 완료 확인 보고 의무화 |

---

## 9. 전주 대비 변화 (W5 → W6)

| 항목 | W5 (23–28.03) | W6 (30.03–03.04) | 변화 |
|------|-------------:|----------------:|------|
| 총 건수 | 54건 | 40건 | ▼ 14건 (-25.9%) |
| ⑤ 전도·낙하·부딪힘 | 24건 | 20건 | ▼ 4건 |
| ④ 떨어짐·낙상 | 20건 | 8건 | ▼ 12건 |
| ③ 감전·합선 | 3건 | 4건 | ▲ 1건 |
| 조치 완료율 | 55.6% (30/54) | **75.0% (30/40)** | ▲ 19.4%p |
| Hankuk 비중 | 53.7% (29건) | 42.5% (17건) | ▼ 11.2%p |
| RTCC 등장 | 0건 | **4건** | 신규 |

> 전체 건수는 감소했으나 ③ 감전 재증가 및 RTCC 신규 등장에 주의 필요.  
> 조치 완료율은 개선됐으나 Hankuk 미조치 6건(③ 감전 포함)은 즉시 후속 조치 요구.

---

*Report prepared by: Hanmi Safety Team*  
*Reference: data_mar2026.csv (No. 199–238)*
